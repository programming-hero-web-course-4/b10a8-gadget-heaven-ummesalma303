...
const ProductDetails = () => {
  ...
  <div className="">
    ...
    <button className='btn border-green-700 px-6 my-3 bg-[#309C081A] text-green-700 rounded-full'>In Stock</button>
   ...
   <h2 className='text-lg font-bold mb-2'>Specification:</h2>
    <ul className='list-decimal list-inside text-lg text-[#09080F99]'>
      {/* <li>{a}</li> */}
    {
      specification&&specification.map(p=> <li>{p}</li>)
    }
    </ul>
   </div>
   ...
   <h3>{rating}</h3>
    <div className="card-actions">
      <button className="btn bg-colorPrimary text-white rounded-full">Add To Card <BsCart4 size={23}/></button>
